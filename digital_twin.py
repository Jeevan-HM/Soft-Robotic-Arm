...
class ArmTwin:
    ...
    def __init__(self,
        ...
        self.cam.lookat[:] = [0.0, 0.0, (cfg.mount_z + cfg.mount_z - cfg.length - cfg.spacer_length) * 0.5]
...
def main():
    ...
    # Manual arm length override — skip calibration
    if args.arm_length is not None:
        twin._arm_length = args.arm_length
        print(f"[twin] Arm length overridden to {args.arm_length*100:.1f} cm")
